  ...
  return (
    <>
      ...
      <div className=" m-auto w-[1144px] 3xl:w-[1430px] text-lg red_hat_text">
        ...
        <div className="flex flex-wrap mb-14 pb-[32px] 3xl:pb-[40px] rounded-xl  mt-14 3xl:mt-[72px] " style={{ background: "#F4F8F6" }}>
          <div className="flex flex-col sm:flex-row ">
            <div className="w-[446px] object-center rounded-xl">
              <img
                className=" object-contain w-[440px] rounded-xl max-w-[440px]"
                height={"410px"}
                src={data[0].img}
                alt=""
              />
