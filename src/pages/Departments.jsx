...
const Departments = () => {
    return (
        <>
            ...
            <h3 className={`w-4/5 mx-auto  mb-10 red_hat_text text-justify text-[22px] 3xl:text-[28px] py-4 font-sans  `}>IIT Roorkee is one of the biggest technical institutions in the country having the largest number of academic units. It has 23 academic departments, 7 academic centres and 7 academic service centres and 1 school.</h3>
